...
AudioUnitRecorderAndPlayer::AudioUnitRecorderAndPlayer(const AudioStreamBasicDescription& format) : format_(format) {
  ...
  bool AudioUnitRecorderAndPlayer::SetUpAudioUnit() {
  ...
  bool AudioUnitRecorderAndPlayer::StartAudioUnit() {
  ...
  void AudioUnitRecorderAndPlayer::StopAudioUnit() {
  ...
  OSStatus AudioUnitRecorderAndPlayer::OnIOUnitRenderNotify(void *              inRefCon,
                                        AudioUnitRenderActionFlags *  ioActionFlags,
                                        const AudioTimeStamp *      inTimeStamp,
                                        UInt32              inBusNumber,
                                        UInt32              inNumberFrames,
                                        AudioBufferList *        ioData) {
    AudioUnitRecorderAndPlayer *rec_and_player = static_cast<AudioUnitRecorderAndPlayer *>(inRefCon);
  ...
  OSStatus AudioUnitRecorderAndPlayer::OnAskingForMoreDataForPlayingRenderCallback(void *              inRefCon,
                                        AudioUnitRenderActionFlags *  ioActionFlags,
                                        const AudioTimeStamp *      inTimeStamp,
                                        UInt32              inBusNumber,
                                        UInt32              inNumberFrames,
  ...
  OSStatus AudioUnitRecorderAndPlayer::OnRecordedDataIsAvailable(void *              inRefCon,
                                           AudioUnitRenderActionFlags *  ioActionFlags,
                                           const AudioTimeStamp *      inTimeStamp,
                                           UInt32              inBusNumber,
                                           UInt32              inNumberFrames,
